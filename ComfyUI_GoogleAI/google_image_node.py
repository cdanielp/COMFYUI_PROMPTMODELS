...
class GoogleAI_ImageNode:
    ...
    Incluye: presets de tamaño, seed, 5 imágenes de referencia, system prompt
    """
    ...
    def generate_image(self, api_key, model, prompt, system_prompt,
                       size_preset, seed, randomize_seed, response_mode,
                       custom_model="",
        ...
        print(f"[GoogleAI] 📐 Preset: {size_preset} -> {aspect_ratio}, {image_size}")
