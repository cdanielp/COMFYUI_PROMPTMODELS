...
Imagen 4 añadido como modelo principal (disponible Feb 2026).
...
IMAGE_MODELS = [
    "imagen-4.0-generate-001",       # Imagen 4 Standard (recomendado)
...
class GoogleAI_ImageNode:
    """Genera imágenes con Imagen 4/3. Error 400 → imagen roja, no crashea."""
